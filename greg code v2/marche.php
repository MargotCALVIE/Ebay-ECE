...
session_start();
	...
	$_SESSION['query'] =$_SESSION['query1'] . "AND (type_achat=0 OR type_achat=3 OR type_achat=4)";}
	if ($_SESSION['sPrix']=="MO"){
	$_SESSION['query'] =$_SESSION['query1'] . "AND (type_achat=1 OR type_achat=4)";}
	if ($_SESSION['sPrix']=="AM"){
	$_SESSION['query'] =$_SESSION['query1'] . "AND (type_achat=2 OR type_achat=3)";}
	//echo $query;//debug
...
<form method="get" action="http://localhost/marche.php" >  
